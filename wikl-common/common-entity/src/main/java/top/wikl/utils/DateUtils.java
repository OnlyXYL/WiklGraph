...
public final class DateUtils  {
   ...
   public static String getTimeyMdHms() {
      return LOCATE_DATE_FORMAT2.format(new Date());
   }
    ...
    * @Description (获取yyyyMMddHHmmss格式)
    */
   public static String getMdHmsByDate(Date date) {
      return LOCATE_DATE_FORMAT2.format(date);
   }
   ...
   public static String formatDateYear(Date date) {
      SimpleDateFormat format = new SimpleDateFormat(DATE_FORMAT_);
