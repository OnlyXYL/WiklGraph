...
import top.wikl.entity.graph.input.vo.ToLowerCaseInputParamVo;
...
/**
 * @author XYL
 * @title: ToLowerCaseInput
 * @description: The Input of toLowerCase
 * @date 2019/10/12 15:58
 * @return
 * @since V1.0
 */
@ApiModel(value = "The Input of toLowerCase")
@NoArgsConstructor
@AllArgsConstructor
@Data
public class ToLowerCaseInput {
    ...
    private List<ToLowerCaseInputParamVo> input;
