...
import top.wikl.entity.graph.input.vo.ReplaceInputParamVo;
 ...
 * @author XYL
 * @title: ReplaceInput
 * @description: The Input of replace
 * @date 2019/10/12 15:26
 * @return
 * @since V1.0
 */
@ApiModel(value = "The Input of replace")
@NoArgsConstructor
@AllArgsConstructor
@Data
public class ReplaceInput {
    ...
    private List<ReplaceInputParamVo> input;
