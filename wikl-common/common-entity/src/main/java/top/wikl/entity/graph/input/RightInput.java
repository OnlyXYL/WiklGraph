...
import top.wikl.entity.graph.input.vo.RightInputParamVo;
 ...
 * @author XYL
 * @title: RightInput
 * @description: The Input of Right
 * @date 2019/10/11 18:32
 * @return
 * @since V1.0
 */
@ApiModel(value = "The Input of Right")
@NoArgsConstructor
@AllArgsConstructor
@Data
public class RightInput {
    ...
    private List<RightInputParamVo> input;
