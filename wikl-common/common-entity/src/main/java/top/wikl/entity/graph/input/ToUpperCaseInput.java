...
import top.wikl.entity.graph.input.vo.ToUpperCaseInputParamVo;
...
/**
 * @author XYL
 * @title: ToUpperCaseInput
 * @description: The Input of toUpperCase
 * @date 2019/10/12 16:01
 * @return
 * @since V1.0
 */
@ApiModel(value = "The Input of toUpperCase")
@NoArgsConstructor
@AllArgsConstructor
@Data
public class ToUpperCaseInput {
    ...
    private List<ToUpperCaseInputParamVo> input;
