...
import top.wikl.entity.graph.input.vo.AppendInputParamVo;
 ...
 * @author XYL
 * @title: AppendInput
 * @description: The Input of Append
 * @date 2019/10/10 17:23
 * @return
 * @since V1.0
 */
@ApiModel(value = "The Input of Append")
@AllArgsConstructor
@NoArgsConstructor
@Data
public class AppendInput {
    ...
    private List<AppendInputParamVo> input;
