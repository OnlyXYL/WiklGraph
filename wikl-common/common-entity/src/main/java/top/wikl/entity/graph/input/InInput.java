...
import top.wikl.entity.graph.input.vo.InInputParamVo;
 ...
 * @author XYL
 * @title: InInput
 * @description: The Input of In
 * @date 2019/10/14 10:15
 * @return
 * @since V1.0
 */
@ApiModel(value = "The Input of In()")
@NoArgsConstructor
@AllArgsConstructor
@Data
public class InInput {
    ...
    private List<InInputParamVo> input;
