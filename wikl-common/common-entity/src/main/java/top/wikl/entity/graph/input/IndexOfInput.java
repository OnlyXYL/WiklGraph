...
import top.wikl.entity.graph.input.vo.IndexOfInputParamVo;
 ...
 * @author XYL
 * @title: IndexOfInput
 * @description: The Input of IndexOf
 * @date 2019/10/11 18:01
 * @return
 * @since V1.0
 */
@ApiModel(value = "The Input of IndexOf")
@NoArgsConstructor
@AllArgsConstructor
@Data
public class IndexOfInput {
    ...
    private List<IndexOfInputParamVo> input;
