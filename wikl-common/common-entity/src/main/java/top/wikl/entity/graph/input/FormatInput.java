...
import top.wikl.entity.graph.input.vo.FormatInputParamVo;
 ...
 * @author XYL
 * @title: FormatInput
 * @description: The Input of format
 * @date 2019/10/12 16:25
 * @return
 * @since V1.0
 */
@ApiModel(value = "The Input of format")
@NoArgsConstructor
@AllArgsConstructor
@Data
public class FormatInput {
    ...
    private List<FormatInputParamVo> input;
