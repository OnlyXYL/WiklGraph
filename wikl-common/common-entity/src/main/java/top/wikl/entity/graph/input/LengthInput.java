...
import top.wikl.entity.graph.input.vo.LengthInputParamVo;
 ...
 * @author XYL
 * @title: LengthInput
 * @description: The Input of Length
 * @date 2019/10/12 15:41
 * @return
 * @since V1.0
 */
@ApiModel(value = "The Input of Length")
@NoArgsConstructor
@AllArgsConstructor
@Data
public class LengthInput {
    ...
    private List<LengthInputParamVo> input;
