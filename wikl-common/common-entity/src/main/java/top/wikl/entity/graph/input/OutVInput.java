...
import top.wikl.entity.graph.input.vo.OutVInputParamVo;
 ...
 * @author XYL
 * @title: OutVInput
 * @description: The Input of outV()
 * @date 2019/10/14 17:09
 * @return
 * @since V1.0
 */
@ApiModel(value = "The Input of outV()")
@NoArgsConstructor
@AllArgsConstructor
@Data
public class OutVInput {
    ...
    private List<OutVInputParamVo> input;
