...
public class MybatisPlusConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(
        ...
        sqlSessionFactory.setTypeEnumsPackage("top.wikl.orientdb.enums");
        sqlSessionFactory.setTypeAliasesPackage("top.wikl.orientdb.model");
    ...
    public MapperScannerConfigurer mapperScannerConfigurer() {
        ...
        scannerConfigurer.setBasePackage("top.wikl.orientdb.mapper*");
